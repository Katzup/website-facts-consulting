...
I recently had the opportunity to speak at the Boston Adaptive Planning Road Show on “Driving Operational Performance and Consolidation using Adaptive Planning” with my client and former CFO of Jaguar Mining, Jim Roller. Jim presented the state of Jaguar Mining circa 2004 at the time he became CFO and the need to develop a Corporate Model, which became an “Excel Hell” until we implemented Adaptive (which Jaguar continues to use for consolidation and planning). Click on this <a href="http://www.factservices.com/wp-content/uploads/2013/09/Driving-Operational-Performance-And-Consolidation-9-16-13.pptx" class="text-navy underline" target="_blank" rel="noopener noreferrer">link</a> for a copy of the presentation slides from our talk.`,
    author: 'Bob Katz',
    date: '2013-10-02',
    category: 'Analytics',
